...
const CategoryCart = ({items}) => {
    ...
    return (
        <div>
            <div class=" my-8 bg-white flex max-w-[330px] flex-col items-center gap-3 rounded-xl border border-gray-100 p-6 text-gray-600 shadow-lg sm:flex-row sm:gap-8">
  <img class="h-20 w-[100px] rounded-full" src={items.img} alt="Profile picture" />
  <div class="flex flex-col items-center text-center sm:items-stretch sm:text-left">
    <div class="mb-2 flex flex-col justify-between sm:flex-row sm:items-center"> 
      <h4 class="mb-4 sm:m-0 text-l font-bold">{items.name}</h4> 
      {/* <div class="flex items-center"> 
        <a href="#" class="mx-1 flex h-8 w-8 items-center justify-center rounded-full border text-lg transition-colors duration-200 ease-in-out hover:bg-gray-300" title="Twitter"
        ...
        ></a>
        <a href="#" class="mx-1 flex h-8 w-8 items-center justify-center rounded-full border text-lg transition-colors duration-200 ease-in-out hover:bg-gray-300" title="Github"
        ...
        ></a>
        <a href="#" class="mx-1 flex h-8 w-8 items-center justify-center rounded-full border text-lg transition-colors duration-200 ease-in-out hover:bg-gray-300" title="LinkedIn"
